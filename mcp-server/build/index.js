...
server.tool("beckn-search", "Search for products or services across Beckn networks (auto-generates most parameters)", BecknSearchParamsSchemaShape, async (params) => {
    try {
